...
function Project() {
  ...
  const getChartData = (project: ProjectDetailResponse): BarChartProps => {
    return {
      xTitle: project.questions[0].title,
      yTitle: project.questions[1].title,
      xLabels: project.questions[0].answers.map((firstAnswer) => firstAnswer.title),
      yLabels: project.questions[1].answers.map((secondAnswer) => secondAnswer.title),
